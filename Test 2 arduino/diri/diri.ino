...
// Right hand only
void fx_action() {
  if (!(servo.exists(4) && servo.exists(5))) return;
  for (action = 0; action < 4; action++) {
    switch (action) {
      case 0:
        servo.move(4, 0x00, 100);
        servo.move(5, 0x00, 100);
//        servo.move(3, 0x00, 50);
        delay(1000);
      break;
      case 1:
        servo.move(4, 0x5A, 150);
        servo.move(5, 0x5A, 150);
//        servo.move(3, 0x55, 50);
        delay(2000);
      break;
      case 2:
        servo.move(4, 0xB4, 100);
        servo.move(5, 0xB4, 100);
